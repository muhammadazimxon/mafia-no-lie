...
import com.leafcellteam.mafia.resources.createYourGame
import com.leafcellteam.mafia.resources.defaultMafiaAndCivilian
import com.leafcellteam.mafia.resources.error
import com.leafcellteam.mafia.resources.gameSetup
...
import com.leafcellteam.mafia.resources.roomSecurity
...
fun CreateGame(
    ...
    if(createGameViewModel.createGameState.isLoading) {
        ConnectingToServerScreen(text = stringResource(Res.string.loading) + "...", modifier = createGameParams.modifier)
    }
    ...
    Box(
        ...
        Column(
            ...
            Box(
                ...
                Text(
                    text = stringResource(Res.string.createYourGame),
                    fontSize = 24.sp,
            ...
            Column(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(Res.string.gameSetup),
                            fontSize = 18.sp,
                            fontWeight = FontWeight.Bold,
                            color = primaryColor
                        )
                ...
                Card(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Text(
                                text = stringResource(Res.string.defaultMafiaAndCivilian),
                                fontSize = 12.sp,
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(Res.string.roomSecurity),
                            fontSize = 18.sp,
                            fontWeight = FontWeight.Bold,
                            color = primaryColor
                        )
        ...
        if(createGameViewModel.createGameState.helpButtonState != null) {
            CustomDialog(
                title = createGameViewModel.createGameState.helpButtonState!!.role::class.simpleName?.lowercase()?.replaceFirstChar { it.uppercase() } ?: stringResource(Res.string.error),
