...
import com.leafcellteam.mafia.resources.leaveGameRoom
import com.leafcellteam.mafia.resources.leaveRoom_condition
import com.leafcellteam.mafia.resources.areYouSureYouWantTo
import com.leafcellteam.mafia.resources.leave_lowerCase
import com.leafcellteam.mafia.resources.theRoom_lowerCase
import com.leafcellteam.mafia.resources.cancel
import com.leafcellteam.mafia.resources.leave
        ...
        Card(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(Res.string.leaveGameRoom),
                        color = Color.White,
                        fontSize = 20.sp,
                    ...
                    Text(
                        text = "${stringResource(Res.string.leaveRoom_condition)}\n\n ${stringResource(Res.string.areYouSureYouWantTo) + stringResource(Res.string.leave_lowerCase) + stringResource(Res.string.theRoom_lowerCase)}",
