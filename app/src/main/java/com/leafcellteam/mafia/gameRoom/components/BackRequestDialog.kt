        ...
        Card(
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(R.string.leaveGameRoom),
                        color = Color.White,
                        fontSize = 20.sp,
                    ...
                    Text(
                        text = "${stringResource(R.string.leaveRoom_condition)}\n\n ${stringResource(R.string.areYouSureYouWantTo) + stringResource(R.string.leave_lowerCase) + stringResource(R.string.theRoom_lowerCase)}",
