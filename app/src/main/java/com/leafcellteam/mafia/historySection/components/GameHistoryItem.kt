    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "${stringResource(R.string.game)}: ${game.gameName}",
                    fontSize = 18.sp,
            ...
            Row(modifier = Modifier.fillMaxWidth()) {
                Column {
                    Row(
                        ...
                        Text(
                            text = "${stringResource(R.string.winner)}: ${game.wonSide}",
                            fontSize = 16.sp,
                ...
                Card(
                    ...
                    Text(text = if(game.isCurrentPlayerWon) stringResource(R.string.WON) else stringResource(R.string.LOST))
                }
            }
            ...
            Text(
                text = "${stringResource(R.string.duration)}: ${game.duration}",
                fontSize = 14.sp,
                color = Color(0xFFB0B0B0)
            )
        }
