            ...
            Column(
                ...
                Box(
                    ...
                    Column(
                        ...
                        Text(
                            stringResource(R.string.MAFIA_ONLINE),
                            color = Color.White,
                            fontSize = 20.sp,
                            fontWeight = FontWeight.Bold
                        )
                        Text(
                            stringResource(R.string.AVAILABLE_ROOMS),
                            color = accentColor,
                            fontSize = 28.sp,
                            fontWeight = FontWeight.Bold
                        )
                ...
                Card(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Text(stringResource(R.string.roomName), color = Color.White, fontSize = 16.sp, fontWeight = FontWeight.Bold, modifier = Modifier.weight(1f))
                            Text(stringResource(R.string.players), color = Color.White, fontSize = 16.sp, fontWeight = FontWeight.Bold, modifier = Modifier.weight(0.5f), textAlign = TextAlign.Center)
                            ...
                            roomState.roomsList.isEmpty() -> {
                                Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
                                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                        ...
                                        Text(text = stringResource(R.string.noRoomsAvailable), color = Color.White.copy(alpha = 0.6f), fontSize = 18.sp)
                                        Text(text = stringResource(R.string.clickUpdateToRefresh),color = Color.White.copy(alpha = 0.4f), fontSize = 14.sp)
                                    }
                                }
                            }
                            else -> {
                                ...
                                if (roomsWithIndices.isEmpty()) {
                                    Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
                                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                            Icon(
                                                painter = painterResource(id = R.drawable.detective),
                                                contentDescription = stringResource(R.string.no) + " ${stringResource(R.string.rooms_lowerCase)}",
                                                tint = Color.White.copy(alpha = 0.6f),
                                                modifier = Modifier.size(80.dp)
                                            )
                                            Spacer(modifier = Modifier.height(16.dp))
                                            Text(stringResource(R.string.no) + stringResource(R.string.active_lowerCase) + stringResource(R.string.rooms_lowerCase), color = Color.White.copy(alpha = 0.6f), fontSize = 18.sp)
                                        }
                                    }
                                } else {
                                    LazyColumn(
                ...
                Card(
                    ...
                    Row(
                        ...
                        ActionButton(stringResource(R.string.update), R.drawable.baseline_system_update_alt_24, accentColor) {
                            roomsScreenViewModel.onEventHandler(RoomEvent.OnUpdate)
                        }
                        ActionButton(stringResource(R.string.random), R.drawable.baseline_transform_24, accentColor) {
