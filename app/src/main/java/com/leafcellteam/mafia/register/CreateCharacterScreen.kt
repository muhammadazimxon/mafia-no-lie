        ...
        Card(
            ...
            Column(
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = { newName ->
                            nameErrorMessage = when {
                                ...
                                newName.length < 3 -> registerViewModel.context.getString(R.string.nameMustContain)
                                newName.length > 20 -> registerViewModel.context.getString(R.string.nameTooLong)
                ...
                /*OutlinedTextField(
                    ...
                    placeholder = {
                        Text(
                            text = stringResource(R.string.repeatNickname),
                            color = Color.White.copy(alpha = 0.6f)
                        )
                    },
                    colors = OutlinedTextFieldDefaults.colors(
                ...
                OutlinedTextField(
                    ...
                    placeholder = {
                        Text(
                            text = stringResource(R.string.enterRepeatPassword),
                            color = Color.White.copy(alpha = 0.6f)
                        )
                    },
                    trailingIcon = {
