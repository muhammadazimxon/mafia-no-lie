        ...
        Row(
            ...
            Row(
                ...
                Image(
                    ...
                    painter = painterResource(rolesChooserParam.role.toImageRes()),
                    contentDescription = "role-image",
                    colorFilter = when (rolesChooserParam.role.toImageRes()) {
                ...
                Text(
                    text = stringResource(R.string.enable) + " " + stringResource(R.string.role) + " " + if(rolesChooserParam.role is Role.Bomber) "Engineer saboteur\n" else rolesChooserParam.role,
                    fontSize = 16.sp,
