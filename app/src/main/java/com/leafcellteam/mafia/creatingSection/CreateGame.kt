...
import com.leafcellteam.mafia.roles.toDescriptionRes
    ...
    Box(
                            ...
                            Surface(
                                ...
                                RolesChooser(
                                    RolesChooserParam(
                                        ...
                                        role = roleData.role,
                                        imageId = roleData.role.toImageRes(),
        ...
        if(createGameViewModel.createGameState.helpButtonState != null) {
            CustomDialog(
                ...
                text = stringResource(createGameViewModel.createGameState.helpButtonState!!.role.toDescriptionRes()),
                roleImage = createGameViewModel.createGameState.helpButtonState!!.role.toImageRes(),
