package com.example.mafiaonlinejetpackcomposecapi.waitingSection.waitingRoomTopBar
...
fun WaitingRoomTopBar(
    ...
    TopAppBar(
        navigationIcon = { Icon(imageVector = Icons.AutoMirrored.Rounded.ArrowBack, contentDescription = "back") },
        title = { Text(
                        ...
                        chosenRoles.forEach { roleResId ->
                            Image(
                                ...
                                colorFilter = when (roleResId) {
                                    ...
                                    R.drawable.lover -> ColorFilter.tint(Color.Cyan)
